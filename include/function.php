<?php
	...
	function binarytoimage_doctor($binaryString, $username, $user_id=null,$flag=null)
	{ 
		$dirswfl = "images/";
	...
	function binarytoimage_prgati($binaryString, $username, $user_id=null,$flag=null)

	{ 

		$dirswfl = "upload/".$pro_id;
	...
	function imaugeUploadwithName($firstname, $images,$news_id=null,$flag=null)
	{
